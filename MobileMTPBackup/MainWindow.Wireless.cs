...
public partial class MainWindow
{
    private async void TestWifi_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            Log($"WI-FI HANDSHAKE OK: {reply} från {host}:{port}; parnyckeln skickades inte i klartext. v5.27 binder AES-256-GCM till kommando, svarshuvud och filblock via AAD.");
        }
